...
// Copyright (c) 2018-2020, The Norchain Developers
//
...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX = 420000;

        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V2 = 500000;

        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3 = 600000;
        ...
        /* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
           You can get this value by doing "print_block 2" in Norchaind. It is used to know what timestamp
         ...
         * - 5 NOR vs 5.12 NOR. You can read this as.. the fee per chunk
    ...
    const char CRYPTONOTE_NAME[] = "Norchain";
    ...
    const int P2P_DEFAULT_PORT = 7777;

    const int RPC_DEFAULT_PORT = 7778;
    ...
    const char LATEST_VERSION_URL[] = "http://latest.Norchain.lol";

    const std::string LICENSE_URL = "https://github.com/Norchain/Norchain/blob/master/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xff, 0xcc, 0xe9, 0x62, 0xc6, 0xae, 0x07, 0x21, 0x56, 0x99, 0x88, 0x66, 0xa6, 0xca, 0x25, 0xe2}};
